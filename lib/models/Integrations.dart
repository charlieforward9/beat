...
class Integrations extends Model {
  ...
  const Integrations._internal({required this.id, required wf_public_id, required wf_profile_bearer, createdAt, updatedAt}): _wf_public_id = wf_public_id, _wf_profile_bearer = wf_profile_bearer, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Integrations({String? id, required String wf_public_id, required String wf_profile_bearer}) {
  ...
  Integrations copyWith({String? id, String? wf_public_id, String? wf_profile_bearer}) {
    return Integrations._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'wf_public_id': _wf_public_id, 'wf_profile_bearer': _wf_profile_bearer, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
