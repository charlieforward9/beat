...
class Goal extends Model {
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'utcDate': _utcDate, 'localDate': _localDate, 'goalCategory': _goalCategory, 'goalCurrentDuration': _goalCurrentDuration, 'goalTargetDuration': _goalTargetDuration, 'goalPercentage': _goalPercentage, 'userOfGoal': _userOfGoal, 'goalOfUser': _goalOfUser, 'goalActivities': _goalActivities, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
