...
class Goal extends Model {
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write(
        "utcDate=" + (_utcDate != null ? _utcDate!.format() : "null") + ", ");
  ...
  Goal.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        _utcDate = json['utcDate'] != null
            ? TemporalDate.fromString(json['utcDate'])
            : null,
